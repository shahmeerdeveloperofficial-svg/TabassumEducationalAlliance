...
const Policies = () => {
  const cmsData = {
    content: [
      ...
      {
        type: "p",
        text: "Tabassum Educational Alliance is committed to a safe and respectful environment for all students. Bullying and harassment in any form are strictly prohibited and will be addressed seriously by the school administration.",
      },
    ],
  };
